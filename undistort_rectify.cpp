...
int main(int argc, char const *argv[])
{
  ...
  cv::Vec3d T;
  cv::Vec4d D1, D2;
  cv::Mat img1 = imread("/home/sourish/vision/FisheyeStereo/scene_imgs/13/left41.jpg", CV_LOAD_IMAGE_COLOR);
  cv::Mat img2 = imread("/home/sourish/vision/FisheyeStereo/scene_imgs/13/right41.jpg", CV_LOAD_IMAGE_COLOR);

  cv::FileStorage fs1("/home/sourish/vision/FisheyeStereo/build/mystereocalib.yml", cv::FileStorage::READ);
  fs1["K1"] >> K1;
  fs1["K2"] >> K2;
  fs1["D1"] >> D1;
  fs1["D2"] >> D2;
