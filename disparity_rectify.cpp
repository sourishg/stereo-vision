...
void generateRightDisparityMap() {
  ...
  msimg1 = Mat(height, width, CV_8UC3, Scalar(0,0,0));
  msimg2 = Mat(height, width, CV_8UC3, Scalar(0,0,0));
  disp_left = imread("/home/sourish/vision/FisheyeStereo/build/disp_left.jpg", CV_LOAD_IMAGE_COLOR);
...
int main(int argc, char const *argv[])
{
  ...
  fs2["F"] >> F;
  //img_res1 = imread("left_rect7.png", CV_LOAD_IMAGE_COLOR);
  //img_res2 = imread("right_rect7.png", CV_LOAD_IMAGE_COLOR);
  //img_res1 = imread("/home/sourish/Downloads/training/colored_0/000011_10.png", CV_LOAD_IMAGE_COLOR);
  //img_res2 = imread("/home/sourish/Downloads/training/colored_1/000011_10.png", CV_LOAD_IMAGE_COLOR);
  img1 = imread("left3.jpg");
  img2 = imread("right3.jpg");
  //img1 = Mat(180, 320, CV_8UC3, Scalar(0,0,0));
  //img2 = Mat(180, 320, CV_8UC3, Scalar(0,0,0));
  //resize(img_res1, img1, Size(320, 180));
  //resize(img_res2, img2, Size(320, 180));
  //img1 = img_res1.clone();
  //img2 = img_res2.clone();
  //computeGradients(img1, grad_left, grad_dir_left);
  //computeGradients(img2, grad_right, grad_dir_right);
  //computeIntegralImgs();
  namedWindow("LEFT", 1);
  namedWindow("RIGHT", 1);
  namedWindow("LEFT_MAP", 1);
  //markTexturelessRegions();
  //normalizeImgs();
  generateLeftDisparityMap();
  //postProcessDisparityMap();
  //groundDisparity();
  //markGroundPlane();
  ...
  while (1) {
    ...
    //imshow("LEFT_MAP_CORRECTED", disp_left_corrected);
    //imshow("RIGHT_MAP", disp_right);
    if (waitKey(0) > 0){
      imwrite("/home/sourish/vision/FisheyeStereo/build/disp_left.png", disp_left);
      //imwrite("/home/sourish/vision/FisheyeStereo/build/disp_left_corrected.jpg", disp_left_corrected);
