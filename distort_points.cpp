...
{
  cv::FileStorage fs1("/home/sourish/vision/FisheyeStereo/build/cam_right.yml", cv::FileStorage::READ);
  img1 = imread("/home/sourish/vision/FisheyeStereo/scene_imgs/9/right1.jpg", CV_LOAD_IMAGE_COLOR);
