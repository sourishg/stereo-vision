...
int main(int argc, char const *argv[])
{
  ...
  img1_distorted = imread("/home/sourish/vision/FisheyeStereo/scene_imgs/12/left5.jpg", CV_LOAD_IMAGE_COLOR);
  img2_distorted = imread("/home/sourish/vision/FisheyeStereo/scene_imgs/12/right5.jpg", CV_LOAD_IMAGE_COLOR);
  img3 = img1.clone();
  img4 = img2.clone();
